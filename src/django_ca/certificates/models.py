...
from django_ca.lib.models import BaseModel, BaseQuerySet, ForeignKey, OneToOneField
...
class ServerName(BaseModel):
    server = ForeignKey(Server, related_name="alternative_names")
